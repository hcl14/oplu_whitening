...
handler = logging.FileHandler('oplu.log')
...
# Network Parameters
n_hidden_1 = 1600 # 1st layer number of neurons
n_hidden_2 = 1600 # 2nd layer number of neurons
n_hidden_3 = 1600 # 3rd layer
n_hidden_4 = 1600
n_hidden_5 = 1600
n_hidden_6 = 1600
n_hidden_7 = 1600
...
def peacewise_activation(x):
    
    return tf.cast((x>1),dtype=tf.float32)*(0.5*x+0.5) + tf.cast((x<-1),dtype=tf.float32)*(0.5*x-0.5) + (tf.ones(tf.shape(x),dtype=tf.float32) - tf.cast((x>1),dtype=tf.float32) - tf.cast((x<-1),dtype=tf.float32))*x


def peacewise_activation_derivative(x):
    
    return tf.cast((x>1),dtype=tf.float32)*0.5 + tf.cast((x<-1),dtype=tf.float32)*0.5 + (tf.ones(tf.shape(x),dtype=tf.float32) - tf.cast((x>1),dtype=tf.float32) - tf.cast((x<-1),dtype=tf.float32))
...
def forwardpropagate_layer(layer_input, weights):
    ...
    layer_a = peacewise_activation(layer_z) #OPLU(layer_z)
...
layer_3_z, layer_3_a = forwardpropagate_layer(layer_2_a, weights['h3'])
layer_4_z, layer_4_a = forwardpropagate_layer(layer_3_a, weights['h4'])
layer_5_z, layer_5_a = forwardpropagate_layer(layer_4_a, weights['h5'])
layer_6_z, layer_6_a = forwardpropagate_layer(layer_5_a, weights['h6'])
layer_7_z, layer_7_a = forwardpropagate_layer(layer_6_a, weights['h7'])
layer_8_z, layer_8_a = forwardpropagate_layer(layer_7_a, weights['h8'])
layer_9_z, layer_9_a = forwardpropagate_layer(layer_8_a, weights['h9'])
layer_10_z, layer_10_a = forwardpropagate_layer(layer_9_a, weights['h10'])
layer_11_z, layer_11_a = forwardpropagate_layer(layer_10_a, weights['h11'])
layer_12_z, layer_12_a = forwardpropagate_layer(layer_11_a, weights['h12'])
layer_13_z, layer_13_a = forwardpropagate_layer(layer_12_a, weights['h13'])
layer_14_z, layer_14_a = forwardpropagate_layer(layer_13_a, weights['h14'])
layer_15_z, layer_15_a = forwardpropagate_layer(layer_14_a, weights['h15'])
layer_16_z, layer_16_a = forwardpropagate_layer(layer_15_a, weights['h16'])
layer_17_z, layer_17_a = forwardpropagate_layer(layer_16_a, weights['h17'])
layer_18_z, layer_18_a = forwardpropagate_layer(layer_17_a, weights['h18'])
layer_19_z, layer_19_a = forwardpropagate_layer(layer_18_a, weights['h19'])
layer_20_z, layer_20_a = forwardpropagate_layer(layer_19_a, weights['h20'])
...
def backpropagate_layer(layer_prev_a, layer_z, weights_next, weights_current, d_layer_z_next, name="layer"):
    ...
    d_layer_z = peacewise_activation_derivative(layer_z)*d_layer_a#oplu_derivative(layer_z, d_layer_a)  # oplu_derivative function is a permutation which acts on d_layer_7_a
    
    # relu drivative:
    #d_layer_z = tf.cast((layer_z>0),dtype=tf.float32)*d_layer_a
...
d_w_18, d_layer_18_z = backpropagate_layer(layer_17_a, layer_18_z, weights['h19'], weights['h18'], d_layer_19_z, name="layer_18")
d_w_17, d_layer_17_z = backpropagate_layer(layer_16_a, layer_17_z, weights['h18'], weights['h17'], d_layer_18_z, name="layer_17")
d_w_16, d_layer_16_z = backpropagate_layer(layer_15_a, layer_16_z, weights['h17'], weights['h16'], d_layer_17_z, name="layer_16")
d_w_15, d_layer_15_z = backpropagate_layer(layer_14_a, layer_15_z, weights['h16'], weights['h15'], d_layer_16_z, name="layer_15")
d_w_14, d_layer_14_z = backpropagate_layer(layer_13_a, layer_14_z, weights['h15'], weights['h14'], d_layer_15_z, name="layer_14")
d_w_13, d_layer_13_z = backpropagate_layer(layer_12_a, layer_13_z, weights['h14'], weights['h13'], d_layer_14_z, name="layer_13")
d_w_12, d_layer_12_z = backpropagate_layer(layer_11_a, layer_12_z, weights['h13'], weights['h12'], d_layer_13_z, name="layer_12")
d_w_11, d_layer_11_z = backpropagate_layer(layer_10_a, layer_11_z, weights['h12'], weights['h11'], d_layer_12_z, name="layer_11")
d_w_10, d_layer_10_z = backpropagate_layer(layer_9_a, layer_10_z, weights['h11'], weights['h10'], d_layer_11_z, name="layer_10")
d_w_9, d_layer_9_z = backpropagate_layer(layer_8_a, layer_9_z, weights['h10'], weights['h9'], d_layer_10_z, name="layer_9")
d_w_8, d_layer_8_z = backpropagate_layer(layer_7_a, layer_8_z, weights['h9'], weights['h8'], d_layer_9_z, name="layer_8")

# layer 7
d_w_7, d_layer_7_z = backpropagate_layer(layer_6_a, layer_7_z, weights['h8'], weights['h7'], d_layer_8_z, name="layer_7")
# layer 6
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            ...
            #grads = [grad1,grad2,grad3,grad4,grad5,grad6,grad7,grad8,grad9,grad10,grad11,grad12,grad13,grad14,grad15,grad16,grad17,grad18,grad19,grad20,grad_out]
